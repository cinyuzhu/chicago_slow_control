...
# CONFIG
########################################
BACKUP_ROOT="/data/sc-local-backup"
REMOTE_USER="sc"
REMOTE_HOST="pollux.pha.ad.jhu.edu"
REMOTE_DIR="/home/sc/jh1-sc-backup"
MYSQL_CNF="/etc/mysql/cron-backup.cnf"
